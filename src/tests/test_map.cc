...
TEST(map, MapInsert1) {
  ...
  my_map.insert(std::make_pair(10, 'i'));
  my_map.insert(std::make_pair(11, 'a'));
  my_map.insert(std::make_pair(12, 'b'));
  my_map.insert(std::make_pair(13, 'c'));
  my_map.insert(std::make_pair(14, 'd'));
  my_map.insert(std::make_pair(15, 'e'));
  my_map.insert(std::make_pair(16, 'f'));
  my_map.insert(std::make_pair(17, 'g'));
  my_map.insert(std::make_pair(18, 'h'));
  my_map.insert(std::make_pair(19, 'i'));
  ...
  orig_map.insert(std::make_pair(6, 'f'));
  orig_map.insert(std::make_pair(7, 'g'));
  orig_map.insert(std::make_pair(8, 'h'));
  orig_map.insert(std::make_pair(9, 'i'));
  orig_map.insert(std::make_pair(10, 'i'));
  orig_map.insert(std::make_pair(11, 'a'));
  orig_map.insert(std::make_pair(12, 'b'));
  orig_map.insert(std::make_pair(13, 'c'));
  orig_map.insert(std::make_pair(14, 'd'));
  orig_map.insert(std::make_pair(15, 'e'));
  orig_map.insert(std::make_pair(16, 'f'));
  orig_map.insert(std::make_pair(17, 'g'));
  orig_map.insert(std::make_pair(18, 'h'));
  orig_map.insert(std::make_pair(19, 'i'));
...
TEST(map, MergeMap) {
  s21::map<int, int> my_map = {{1, 1},  {4, 4},  {2, 2},
                               {11, 1}, {14, 4}, {12, 2}};
  s21::map<int, int> my_map_merge = {{3, 3}, {4, 4}, {13, 3}, {14, 4}};

  std::map<int, int> orig_map = {{1, 1},  {4, 4},  {2, 2},
                                 {11, 1}, {14, 4}, {12, 2}};
  std::map<int, int> orig_map_merge = {{3, 3}, {4, 4}, {13, 3}, {14, 4}};
